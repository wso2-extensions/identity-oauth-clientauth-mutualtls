...
public class AbstractMTLSTokenBindingGrantHandlerTest {
    ...
    private static String certificateContent = "-----BEGIN CERTIFICATE-----MIID3TCCAsWgAwIBAgIUJQW8iwYsAbyjc/oHti" +
    ...
    private static OAuth2AccessTokenReqDTO oauth2AccessTokenReqDTOObject() {
        ...
        oauth2AccessTokenReqDTO.setHttpRequestHeaders(getHttpRequestHeaders
                (new String[]{"content-type", "x-wso2-mutual-auth-cert", "user-agent"},
                        new String[]{"application/x-www-form-urlencoded", certificateContent,
    ...
    public void testValidateScope() throws IdentityOAuth2Exception {
        ...
        try (MockedStatic<IdentityUtil> identityUtil = mockStatic(IdentityUtil.class);
             MockedStatic<Oauth2ScopeUtils> oauth2ScopeUtil = mockStatic(Oauth2ScopeUtils.class)) {

            identityUtil.when(() -> IdentityUtil.getProperty((CommonConstants.MTLS_AUTH_HEADER)))
            ...
            oauth2ScopeUtil.when(() ->
                    Oauth2ScopeUtils.validateByApplicationScopeValidator(any(OAuthTokenReqMessageContext.class),
