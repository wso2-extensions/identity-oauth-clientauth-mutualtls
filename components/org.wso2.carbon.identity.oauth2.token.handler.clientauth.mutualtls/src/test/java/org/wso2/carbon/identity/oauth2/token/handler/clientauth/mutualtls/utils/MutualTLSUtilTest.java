...
public class MutualTLSUtilTest {
    ...
    public void testGetThumbPrint() throws Exception {
        ...
        String certificateContent = "MIIDmzCCAoOgAwIBAgIJAJuzH6NrV5s5MA0GCSqGSIb3DQEBCwUAMGQxCzAJBgNV"
    ...
    public void testIsJwksUriConfigured() throws Exception {
        ...
        try (MockedStatic<OAuth2Util> oAuth2Util = mockStatic(OAuth2Util.class)) {
            ...
            serviceProviderProperties[0] = serviceProviderProperty;
            serviceProvider.setSpProperties(serviceProviderProperties);
            oAuth2Util.when(() -> OAuth2Util.getServiceProvider(clientID, SUPER_TENANT_DOMAIN_NAME))
    ...
    public void testReadHTTPConnectionConfigValue() {
        ...
        try (MockedStatic<IdentityUtil> identityUtil = mockStatic(IdentityUtil.class)) {
            identityUtil.when(() -> IdentityUtil.getProperty("path")).thenReturn("xPath");
            assertEquals(MutualTLSUtil.readHTTPConnectionConfigValue("path"), 0);
            identityUtil.when(() -> IdentityUtil.getProperty("path")).thenReturn("123");
